...
class TestFindingsApiKpiTypeClass(unittest.TestCase):
    app = {}
    @classmethod
    def setup_class(cls):
        print("\nrunning setup preparation...")

        TestFindingsApiKpiTypeClass.app = KpiType(aggregation_type="abc"
                                                  )
        # read env vars
    ...
    def test_from_dict_value_error(self):
       self.assertRaises(
            ValueError, KpiType._from_dict, {})

    """_from_dict test cases """
    def test_from_dict_bad_key_neg(self):
        self.assertRaises(
            ValueError, KpiType._from_dict, {"bad_key": "abc"})

    """_to_dict test cases """
    def test_to_dict_success(self):
        TestFindingsApiKpiTypeClass.app.to_dict()
    
    """__str__ test cases """
    def test__str__success(self):
        TestFindingsApiKpiTypeClass.app.__str__()

    """__eq__ test cases """

    def test__eq__isinstance(self):
        TestFindingsApiKpiTypeClass.app.__eq__(TestFindingsApiKpiTypeClass.app)

    def test__eq__not_isinstance(self):
        TestFindingsApiKpiTypeClass.app.__eq__({})

    """__ne__ test cases """

    def test__ne__isinstance(self):
        TestFindingsApiKpiTypeClass.app.__ne__(TestFindingsApiKpiTypeClass.app)
