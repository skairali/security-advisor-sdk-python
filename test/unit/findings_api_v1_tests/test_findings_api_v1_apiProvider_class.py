...
class TestFindingsApiApiProviderClass(unittest.TestCase):
    app = {}
    @classmethod
    def setup_class(cls):
        print("\nrunning setup preparation...")
        
        TestFindingsApiApiProviderClass.app = ApiProvider(
            id="abc",name="abc",
        )
    ...
    def test_from_dict_bad_key_neg(self):
        self.assertRaises(
            ValueError, ApiProvider._from_dict, {"bad_key": "abc"})

    def test_from_dict_success(self):
        with mock.patch('ibm_cloud_security_advisor.findings_api_v1.string_to_datetime') as mocked_os:
            ApiProvider._from_dict({
                "name": "abc", "id": "abc"
            })

    """_to_dict test cases """
    def test_to_dict_success(self):
        TestFindingsApiApiProviderClass.app.to_dict()

    """__eq__ test cases """

    def test__eq__isinstance(self):
        TestFindingsApiApiProviderClass.app.__eq__(TestFindingsApiApiProviderClass.app)

    def test__eq__not_isinstance(self):
        TestFindingsApiApiProviderClass.app.__eq__({})

    """__ne__ test cases """

    def test__ne__isinstance(self):
        TestFindingsApiApiProviderClass.app.__ne__(TestFindingsApiApiProviderClass.app)
